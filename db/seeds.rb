...
Product.create(symbol: 'ASC', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'INSW', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'TNK', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'PBF', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'MTR', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'AMR', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'AMD', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'AAPL', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'NVDA', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'AMZN', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'CCL', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'ZYME', amount: 1000, percentage: 20, user_id: User.first.id)
Product.create(symbol: 'WFC', amount: 1000, percentage: 20, user_id: User.first.id)
